...
RUN wget https://dlcdn.apache.org/tomcat/tomcat-11/v11.0.2/bin/apache-tomcat-11.0.2.zip
RUN unzip apache-tomcat-11.0.2
RUN mv apache-tomcat-11.0.2 /mnt/tomcat/
